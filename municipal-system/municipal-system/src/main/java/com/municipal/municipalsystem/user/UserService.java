...
public class UserService {
    ...
    public User register(RegisterRequest request) {
        ...
        if ("BUSINESS".equals(request.getRole())
                && userRepository.existsByBusinessLicenseNumber(request.getBusinessLicenseNumber())) {

            throw new RuntimeException("Business license number already exists.");
        }
